...
const stylebutton = { position:"absolute", left:1120,marginRight:120,float:"right",marginTop:4,top:7,height:30,borderRadius:50,};
const styleavatar = {float:"right",position:"absolute",left:1070,marginRight:20,marginTop:1,};
